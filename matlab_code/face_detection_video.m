...
function face_detection_video()
    ...
    frontalFaceCARTDetector = vision.CascadeObjectDetector('FrontalFaceCART');
    frontalFaceLBPDetector = vision.CascadeObjectDetector('FrontalFaceLBP');
    ...
    while runLoop
        ...
        if numPts < 1000000
           ...
           bbox_1 = frontalFaceCARTDetector.step(videoFrameGray);
           bbox_2 = frontalFaceLBPDetector.step(videoFrameGray);
           bbox_3 = profileFaceDetector.step(videoFrameGray);
           fprintf(' [MODE] Detection mode \n');
           
           bbox = cat(1, bbox_1, bbox_2);
           bbox = cat(1, bbox , bbox_3);
    ...
    release(videoPlayer);
    release(pointTracker);
    release(frontalFaceCARTDetector);
    release(frontalFaceLBPDetector);
    release(profileFaceDetector);
